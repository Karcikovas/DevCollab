 ...
 */
final class Version20191107183651 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE skills CHANGE branch branch VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE skill ADD branch VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE skill DROP branch');
        $this->addSql('ALTER TABLE skills CHANGE branch branch VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
        $this->addSql('ALTER TABLE team_points CHANGE team_fk team_fk INT DEFAULT NULL, CHANGE points points INT DEFAULT NULL');
        $this->addSql('ALTER TABLE team_tasks CHANGE team_fk team_fk INT DEFAULT NULL');
